...
function HomePage() {
  return (
    <div className="snap-y">
      {/* 1 */}
      <div className="relative min-h-[calc(100vh_-_5rem)] bg-black snap-start grid grid-cols-3 gap-0">
        {/* Cone */}
        ...
        <div className="relative z-20 flex items-center col-span-3 pt-8 text-center sm:col-span-1 lg:text-right">
