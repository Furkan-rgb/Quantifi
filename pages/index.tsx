  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <main className="flex items-center h-full px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div className="items-start sm:text-center lg:text-left">
